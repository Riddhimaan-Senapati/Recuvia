      ...
      <div className="max-w-4xl mx-auto bg-card p-8 rounded-lg shadow-md border border-border/50">
        ...
        <div className="prose dark:prose-invert max-w-none space-y-8">
          ...
          <section className="space-y-4">
            <h2 className="text-2xl font-bold text-lost border-b pb-2">
              Introduction
            </h2>
            <p className="text-base leading-relaxed">
              At Recuvia, we take your privacy seriously. This Privacy Policy
          ...
          <section className="space-y-4">
            ...
            <p className="text-base leading-relaxed">
              ...
              These services may have access to your information solely to
          ...
          <section className="space-y-4">
            ...
            <p className="text-base leading-relaxed">
              ...
              <a
                ...
                className="text-lost font-medium hover:underline"
              >
